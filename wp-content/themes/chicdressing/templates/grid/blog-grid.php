...
<div class="main-container">
	...
	echo '<li class="blog-grid-item">';
	echo '<h2 id="leblog" class="chic-title">Marques de Luxe, Créateurs,Actus...Dernières publications!</h2>';
	echo '</li>';
	...
	echo '</ul>';
	echo '<p class="text-center"><a class="chic-bouton" href="/chic___dressing/#leblog">Voir tous les articles</a></p>';
